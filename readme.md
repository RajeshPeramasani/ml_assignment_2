...
## 1. Problem Statement
The objective of this assignment is to implement, evaluate, and deploy multiple machine
learning classification models on a real-world dataset. The assignment demonstrates an
end-to-end machine learning workflow including data preprocessing, model training,
performance evaluation using standard metrics, and deployment of an interactive web
